...
@WebMvcTest(value = GarmentController.class)
@Import(GarmentService.class)
...
class GarmentControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Garment.class);
      flux = Arrays.asList(generator.nextObject(Garment.class), generator.nextObject(Garment.class));
