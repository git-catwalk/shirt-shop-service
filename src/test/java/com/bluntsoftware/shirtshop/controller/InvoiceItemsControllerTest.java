...
@WebMvcTest(value = InvoiceItemsController.class)
@Import(InvoiceItemsService.class)
...
class InvoiceItemsControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(InvoiceItems.class);
      flux = Arrays.asList(generator.nextObject(InvoiceItems.class), generator.nextObject(InvoiceItems.class));
