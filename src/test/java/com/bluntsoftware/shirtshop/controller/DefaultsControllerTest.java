...
@WebMvcTest(value = DefaultsController.class)
@Import(DefaultsService.class)
...
class DefaultsControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Defaults.class);
      flux = Arrays.asList(generator.nextObject(Defaults.class), generator.nextObject(Defaults.class));
