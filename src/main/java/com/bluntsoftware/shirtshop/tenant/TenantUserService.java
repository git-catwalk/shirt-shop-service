...
import com.bluntsoftware.shirtshop.config.SaasyConfig;
...
public class TenantUserService {
    ...
    public static Optional<TenantUser> getUser(String accessToken){
        ...
        String customerAPIUrl = SaasyConfig.SASSY_URI + "/api/v1/" + SaasyConfig.SASSY_APP_ID + "/me/" + TenantResolver.resolve();
